	...
	; Compiler options:
	;
	; -ouser_project.cof -muser_project.map --summary=default \
	; --output=default sys_init.p1 test_61f02x_comp.p1 test_61f02x_ee.p1 \
	; test_61f02x_iic.p1 test_61f02x_int.p1 test_61f02x_pwm.p1 \
	; test_61f02x_spi.p1 test_61f02x_vreg.p1 test_61f022_adc.p1 \
	; user_project.p1 buzzer.p1 --chip=16F685 -P --runtime=default \
