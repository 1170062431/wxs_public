...
#define		ADC_VREFI_ENABLE()		(_vrefips = 1)
#define		ADC_VREFI_DISABLE()		(_vrefips = 0)

#define		ADC_VREF_ENABLE()		(_vrefps = 1)
#define		ADC_VREF_DISABLE()		(_vrefps = 0)
...
//	#define		ADC_REF_VOLTAGE_VREFI		(1)
//	#define		ADC_REF_VOLTAGE_VREFIx2		(1)
//	#define		ADC_REF_VOLTAGE_VREFIx3		(1)
//	#define		ADC_REF_VOLTAGE_VREFIx4		(1)
