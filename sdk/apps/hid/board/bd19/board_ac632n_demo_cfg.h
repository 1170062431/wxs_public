...
#define TCFG_UART0_TX_PORT  				IO_PORT_DP// IO_PORTA_01              //串口发送脚配置
...
#define TCFG_IOKEY_POWER_ONE_PORT			IO_PORTB_07        //IO按键端口

#define TCFG_IOKEY_VOLUP_CONNECT_WAY		ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_VOLUP_ONE_PORT			IO_PORTA_00

#define TCFG_IOKEY_VOLDN_CONNECT_WAY 		ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_VOLDN_ONE_PORT			IO_PORTB_06

#define TCFG_IOKEY_NEXT_CONNECT_WAY 		ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_NEXT_ONE_PORT			IO_PORTA_01

#define TCFG_IOKEY_PREV_CONNECT_WAY			ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_PREV_ONE_PORT			IO_PORTB_05
...
#define TCFG_LOWPOWER_VDDIOM_LEVEL			VDDIOM_VOL_26V
/*弱VDDIO等级配置，可选：
