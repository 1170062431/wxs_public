...
static void mp3_tone_mutex_play(void *priv)
{
	...
	//user add
	case TONE_FAST:				//强力模式
        tone_name = RES_TONE_FAST_MP3;
        break;
	case TONE_SLOW:				//舒缓模式
        tone_name = RES_TONE_SLOW_MP3;
        break;
	case TONE_HEAT_HIGH:		//加热高档
        tone_name = RES_TONE_HEAT_HIGH_MP3;
        break;
	case TONE_HEAT_MID:			//加热中档
        tone_name = RES_TONE_HEAT_MID_MP3;
        break;
	case TONE_HEAT_LOW:			//加热低档
        tone_name = RES_TONE_HEAT_LOW_MP3;
        break;
	case TONE_HEAT_OFF:			//加热关闭
        tone_name = RES_TONE_HEAT_OFF_MP3;
        break;
	case TONE_PAUSE:			//暂停
        tone_name = RES_TONE_PAUSE_MP3;
        break;
	case TONE_BAT_LOW:			//电量不足
        tone_name = RES_TONE_BAT_LOW_MP3;
        break;
	case TONE_IS_CHARGE:		//充电中
        tone_name = RES_TONE_IS_CHARGE_MP3;
        break;
	case TONE_BAT_FULL:			//充满电
        tone_name = RES_TONE_BAT_FULL_MP3;
        break;
	
	case TONE_MSG_R:			//正向按摩
        tone_name = RES_TONE_MSG_R_MP3;
        break;
	case TONE_MSG_L:			//反向按摩
        tone_name = RES_TONE_MSG_L_MP3;
        break;
	case TONE_MSG_AUTO:			//自动按摩
        tone_name = RES_TONE_MSG_AUTO_MP3;
        break;
	case TONE_TIMER_SET:		//设置时间
        tone_name = RES_TONE_TIMER_SET_MP3;
        break;
	case TONE_MODE_SET:			//设置模式
        tone_name = RES_TONE_MODE_SET_MP3;
        break;
	//user add end
    }
...
void tone_play(u8 index, u8 repeat_flag)
{
    ...
    return;
#endif
    if (get_going_to_pwr_off() && (index != TONE_POWER_OFF) && (index != TONE_POWER_DOWN)) { //关机过程不播其它提示音
        return;
    }
