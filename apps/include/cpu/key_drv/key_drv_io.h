...
#define IS_KEY0_DOWN()    (!PORTR_IN(PORTR3))        //PP PORTR3
#define IS_KEY1_DOWN()    0
#define IS_KEY2_DOWN()    0
#define IS_KEY3_DOWN()    0
#define KEY_INIT()        do{PORTR_PU(PORTR3,1);PORTR_PD(PORTR3,0);PORTR_DIR(PORTR3,1);}while(0)
#else
#define IS_KEY0_DOWN()    (!PORTR_IN(PORTR3))        //PP PR2
#define IS_KEY1_DOWN()    (!(JL_PORTB->IN & BIT(2)))
#define IS_KEY2_DOWN()    (!(JL_PORTB->IN & BIT(3)))
#define IS_KEY3_DOWN()    (!(JL_PORTB->IN & BIT(4)))

#define KEY_INIT()        do{PORTR_PU(PORTR3,1);PORTR_PD(PORTR3,0);PORTR_DIR(PORTR3,1);\
