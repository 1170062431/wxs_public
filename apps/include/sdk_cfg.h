...
#ifdef __DEBUG
//串口打印IO口选则
#define DEBUG_UART_SEL          UART1_USB_TXDP_RXDM	//UART1_USB_TXDP_RXDM//UART2_TXPC4_RXPC5
//串口波特率选则
#define DEBUG_UART_RATE         9600    //115200 460800
//打印函数
...
#ifdef USER_UART_EN
//串口打印IO口选则
#define USER_UART_SEL			UART2_TXPC4_RXPC5	//UART1_USB_TXDP_RXDM UART0_TXPA7_RXPA8 UART2_TXPC4_RXPC5
//串口波特率选则
#define USER_UART_RATE			9600
//打印函数
...
#define LOW_POWER_NOISE_DEAL    1   //低电时底噪处理，该问题存在于VDDIO和HPVDD绑在一起的封装
...
#define EQ_RUN_SEL              EQ_RUN_NULL    /*更多音效设置请在audio_stream.h头文件配置*/
//EQ 串口在线调试使能
...
//<自动mute-------------------mute------------mute-------mute-------mute----mute-----mute----mute-----mute----mute
#define DAC_AUTO_MUTE_EN	    1
//<按键音
#define TONE_EN     	    	1
//<非0表示使用默认音量
#define SYS_DEFAULT_VOL         30
//<非0表示提示音使用默认音量
#define TONE_DEFAULT_VOL        25
...
#define USB_DISK_EN             0//1
#define USB_PC_EN               0//1
...
#define BT_TWS                  0//BT_TWS_TRANSMIT//BT_TWS_TRANSMIT
#if BT_TWS
#undef  EQ_RUN_SEL
...
#define SNIFF_MODE_CONF	       SNIFF_EN//	SNIFF_EN
//可选配置：BT_POWER_DOWN_EN/BT_POWER_OFF_EN
#define BT_LOW_POWER_MODE      BT_POWER_OFF_EN// BT_POWER_DOWN_EN
//可选配置：BT_OSC/RTC_OSCH/RTC_OSCL/LRC_32K
#define LOWPOWER_OSC_TYPE     LRC_32K // LRC_32K
//可选配置：32768L//24000000L//32000L
#define LOWPOWER_OSC_HZ       32000L//  32000L
...
//<SBC
#define DEC_TYPE_SBC_ENABLE     0//1
//<AAC
#define DEC_TYPE_AAC_ENABLE		0//0
//<8K_code_space
#define DEC_TYPE_WAV_ENABLE     0//1
//<8K_code_space
#define DEC_TYPE_FLAC_ENABLE    0//1
//<8K_code_space
#define DEC_TYPE_APE_ENABLE     0//1
//<32K_code_space
#define DEC_TYPE_WMA_ENABLE     0//1
//<32K_code_space
#define DEC_TYPE_F1A_ENABLE     0//1
//<2K_code_space
#define DEC_TYPE_NWT_ENABLE     0//1
//<76K_code_space
#define DEC_TYPE_AMR_ENABLE     0//1
//<60K_code_space
#define DEC_TYPE_M4A_ENABLE     0//1
//<112K_code_space
#define DEC_TYPE_DTS_ENABLE     0//1
