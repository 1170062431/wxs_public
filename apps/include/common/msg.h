...
//TASK_MSG_START_LINE
    ...
    MSG_BT_FCC,
//	/*	//user add
	MSG_BLE_CONNECT_SUCCSEE,	//BLE连接成功，开始对码操作
	MSG_BLE_CONNECT_RECEIVED,	//BLE连接对码数据接收完毕
#if (PRO_TYPE == PRO_JTJ)
	MSG_BT_JTJ_BEGIN,			//消息起始，无实际意义
	MSG_BT_JTJ_POW_CTR,			//开关机
	MSG_BT_JTJ_ADD_FUNC_CTR,	//附加功能
	MSG_BT_JTJ_START_STOP_CTR,	//启动/暂停
	MSG_BT_JTJ_SPEED_CTR,		//速度
	MSG_BT_JTJ_MODE_CTR,		//模式
	MSG_BT_JTJ_TIMER_CTR,		//定时
	MSG_BT_JTJ_DATA_QUERY_CTR,	//数据查询
	MSG_BT_JTJ_DATA_UPDATE_CTR,	//数据更新
	MSG_BT_JTJ_NON,				//保留
	MSG_BT_JTJ_CMD_FB,
	MSG_BT_JTJ_STATE_UPDATE,
	MSG_BT_JTJ_AUTO_CMD_FEEDBACK,
	MSG_BT_JTJ_END,				//消息结束，无实际意义
#elif (PRO_TYPE == PRO_ZNSZ)
	MSG_BT_ZNSZ_BEGIN,			//消息起始，无实际意义
//	MSG_BT_ZNSZ_TIME_AND_WEATHER_REPORT,
	MSG_BT_ZNSZ_TIME_REPORT,
	MSG_BT_ZNSZ_WEATHER_REPORT,
	MSG_BT_ZNSZ_BATTERY_VAL_REPORT,
	MSG_BT_ZNSZ_ADDR_REPORT,
	MSG_BT_ZNSZ_CALL,
	MSG_BT_ZNSZ_SOS,
	MSG_BT_ZNSZ_BATTERY_VAL_QUERY,
	MSG_BT_ZNSZ_END,			//消息结束，无实际意义
#elif (PRO_TYPE == PRO_AMZ)
	MSG_BT_AMZ_BEGIN,			//消息起始，无实际意义
	//AMQ BLE.................................
	MSG_BT_AMZ_POWER_ON_OFF_CTR,
	MSG_BT_AMZ_START_STOP_CTR,
	MSG_BT_AMZ_HEAT_CTR,
	MSG_BT_AMZ_MASSAGE_CTR,
	MSG_BT_AMZ_MASSAGE_TYPE_CTR,
	MSG_BT_AMZ_SPEED_CTR,
	MSG_BT_AMZ_TIME_CTR,
	MSG_BT_AMZ_USER_DEFINE,
	MSG_BT_AMZ_SET_MODE,
	MSG_BT_AMZ_MUTE_EN,
	MSG_BT_AMZ_DATA_QUERY,
	MSG_BT_AMZ_DATA_UPDATE,
	MSG_BT_AMZ_AUTO_CMD_FEEDBACK,
	//AMQ BT.................................
	MSG_BT_AMQ_POWER_ON,
	MSG_BT_AMQ_POWER_OFF,
	MSG_BT_AMQ_PAUSE,
	MSG_BT_AMQ_SET_SPEED_LEVEL,
	MSG_BT_AMQ_SET_HEAT_LEVEL,
	MSG_BT_AMQ_LOWPOWER,
	MSG_BT_AMQ_CHARGING,
	MSG_BT_AMQ_CHARGEND,
	MSG_BT_AMQ_TONE_PLAY_HEAT,
	MSG_BT_AMZ_END,			//消息结束，无实际意义
#elif (PRO_TYPE == PRO_XXX)		//未定义
	MSG_BT_XXX_BEGIN,			//消息起始，无实际意义
	MSG_BT_XXX_END,			//消息结束，无实际意义
#endif
#if USER_KEY_IR_EN
	MSG_USER_KEY_IR_BEGIN,
	MSG_USER_KEY_IR_K1,
	MSG_USER_KEY_IR_K2,
	MSG_USER_KEY_IR_K3,
	MSG_USER_KEY_IR_K4,
