...
@rem 文件下载列表
isd_download.exe -tonorflash -dev br21 -boot 0x2000 -div6 -wait 300  -f uboot.boot sdk.app bt_cfg.bin  bt.mp3 power_off.mp3 power_down.mp3 fast.mp3 slow.mp3 heat_high.mp3 heat_mid.mp3 heat_low.mp3 heat_off.mp3 pause.mp3 bat_low.mp3 ischarge.mp3 bat_full.mp3 mode_set.mp3 msg_auto.mp3 msg_l.mp3 msg_r.mp3 timer_set.mp3
